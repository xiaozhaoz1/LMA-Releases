...
[![Minecraft](https://img.shields.io/badge/Minecraft-1.20.1-green)](https://minecraft.net) [![Forge](https://img.shields.io/badge/Forge-47.4.18-blue)](https://files.minecraftforge.net/) [![Java](https://img.shields.io/badge/Java-17-red)](https://adoptium.net/) [![License](https://img.shields.io/badge/License-MIT-yellow)](LICENSE)
...
| Java | **17** |
| Touhou Little Maid | **1.5.0+** (355044) |
...
| COMPAT 兼容 | 10 | `set_ysm_model`, `slashblade_sa`, `tpm_force_guard` 等 |
...
```
input/   纯查询  — MaidStateReader(120) + TargetStateReader(25) + WorldStateReader(19)
output/  纯命令  — CombatOutput(24) + WorldOutput(24) + MaidStateWriter(53) + MovementOutput(16) +
...
execute/ 编排层 — CraftExecute, FurnaceExecute, JukeboxExecute, BellExecute,
                   ContainerExecute, SmeltExecute, PlaceBlockExecute, AltarExecute, AnimExecute
api/     SPI     — ItemResolver, ParamExtractor, BaseStateMachine, BrainHelper
```
...
| **TPM** (True Power of Maid) | 强制格挡 | 17 | 1 |
...
### 自定义音效
将 `.ogg` 放入 `config/littlemaidmoreaction/sounds/` → F3+T 热重载
...
| 版本 | 日期 | 内容 |
|------|------|------|
| **v29** | 2026-07-13 | I/O 完善 346方法, 55/110动作委托, 7 Execute, TLM API编目 |
