package com.github.xiaozhaoz1.littlemaidmoreaction.api.io;
...
public interface IExecutor {
    ...
    /**
     * v75.4: tick→CONTINUE 样板工厂 — 取代逐类匿名 IExecutor 壳
     * (TaskStateMachine/TimerBasedCreatePipeline/RunningBeltPipeline/MaidAssemblyPipeline)。
     * 带前置条件的覆写 (如 ArmTransferPipeline 的坐标守卫) 不适用, 保留原样。
     */
    static IExecutor ticker(java.util.function.BiConsumer<ServerLevel, EntityMaid> tick) {
        return (world, maid, pos, data) -> {
            tick.accept(world, maid);
