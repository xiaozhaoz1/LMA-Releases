...
public final class VanillaConstants {
    ...
    public static final double ARRIVE_DIST_SQR = 9.0;     // 3 格球 — 破块门 (蓄力攻击距离, v79.26.8)
    public static final double ONE_AWAY_DIST_SQR = 3.0;   // 1 格邻域 (3x3x3 相邻格) — 寻路到达判定
                                                          // (v79.26.8 用户: "至少要走到矿旁边" 回归 v79.19n)
    public static final double DIG_DIRECT_DIST_SQR = 8.0; // 2.83 球 — 扫描目标直接开脉
                                                          // (v79.26.8: 攻击距离 3.0 留余量防卡极限; 水平
                                                          // 3 格外目标走寻路走近, 头顶 2 格仍直接挖)
