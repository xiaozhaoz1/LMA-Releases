package com.github.xiaozhaoz1.littlemaidmoreaction.vanilla.maideditor;

import com.github.tartaricacid.touhoulittlemaid.entity.passive.EntityMaid;
import com.github.tartaricacid.touhoulittlemaid.init.InitAttribute;
import com.github.tartaricacid.touhoulittlemaid.init.InitItems;
import com.github.xiaozhaoz1.littlemaidmoreaction.api.maideditor.FieldType;
import com.github.xiaozhaoz1.littlemaidmoreaction.api.maideditor.MaidEditorRegistry;
import com.github.xiaozhaoz1.littlemaidmoreaction.vanilla.input.maid.MaidStateReader;
import com.github.xiaozhaoz1.littlemaidmoreaction.vanilla.output.maid.MaidStateWriter;
...
//?} else {
                m -> f0(m.getAttributeValue(InitAttribute.MAID_HUNGER)), null);
//?}
...
//?} else {
                m -> { var s = MaidStateReader.getTamedItem(m); return s.isEmpty() ? "none" : BuiltInRegistries.ITEM.getKey(s.getItem()).toString(); }, null);
//?}
...
//?} else {
                m -> { var s = MaidStateReader.getTemptationItem(m); return s.isEmpty() ? "none" : BuiltInRegistries.ITEM.getKey(s.getItem()).toString(); }, null);
//?}
    }
