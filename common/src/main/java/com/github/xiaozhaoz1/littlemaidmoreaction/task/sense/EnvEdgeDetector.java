 ...
 * 保留检出 = 有消费方的 4 种: SNOWING / WEATHER_CLEAR / DARKNESS / MAID_NEARBY
 * (v79.62.5: TEMP_COLD/HOT/NORMAL 删 — 温度边沿检测删, TLM 温度机制覆盖; FESTIVAL_ENTER 为 stateless 广播, 不经此检) 。
 *
...
public final class EnvEdgeDetector {
    ...
    /** 阈值配置 — 由 PassiveTaskConfig 注入 (v79.62.5: cold/hot 删 — 温度边沿检测删, 用户裁定) */
    public record EnvConfig(int darknessThreshold) {}
