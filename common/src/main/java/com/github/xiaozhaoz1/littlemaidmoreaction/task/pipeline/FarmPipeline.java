...
import com.github.xiaozhaoz1.littlemaidmoreaction.vanilla.execute.FarmExecute;
 ...
 *
 * <p>区域存储: config/farm_regions.json 按女仆 uuid ({@link FarmRegionStorage});
...
public final class FarmPipeline implements TaskPipeline, TaskConfigurable {
    ...
    public PipelineResult validate(ServerLevel level, EntityMaid maid, PipelineContext ctx) {
        if (!FarmRegionStorage.hasAny(maid.getStringUUID())) {
