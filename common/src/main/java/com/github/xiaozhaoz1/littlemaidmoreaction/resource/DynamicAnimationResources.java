...
public final class DynamicAnimationResources implements PackResources {
    ...
    public net.minecraft.server.packs.PackLocationInfo location() {
        return new net.minecraft.server.packs.PackLocationInfo(PACK_ID, net.minecraft.network.chat.Component.literal("LMA Custom Animations"), net.minecraft.server.packs.repository.PackSource.BUILT_IN, java.util.Optional.empty());
    }
    //?}
    public void reload() {
        resources.clear();
