...
/** 女仆日程 (getSchedule → DAY/NIGHT/ALL)。 */
@RuleCondition
public final class MaidScheduleCondition implements ICondition {
    @Override public String key() { return "maid_schedule"; }
    @Override public String displayName() { return "女仆日程"; }
    ...
    public String evaluate(RuleContext ctx, Map<String, String> rawParams) {
        return MaidStateReader.getSchedule(ctx.maid());
    }
}
