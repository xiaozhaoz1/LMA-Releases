...
/** 女仆幸运值 (getLuck)。 */
@RuleCondition
public final class MaidLuckCondition implements ICondition {
    @Override public String key() { return "maid_luck"; }
    @Override public String displayName() { return "女仆幸运"; }
    ...
    public String evaluate(RuleContext ctx, Map<String, String> rawParams) {
        return String.format("%.1f", MaidStateReader.getLuck(ctx.maid()));
    }
}
