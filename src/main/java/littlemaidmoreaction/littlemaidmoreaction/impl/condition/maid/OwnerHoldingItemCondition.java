...
@RuleCondition
public final class OwnerHoldingItemCondition implements ICondition {
    @Override public String key() { return "owner_holding_item"; }
    @Override public String displayName() { return "主人手持"; }
    ...
    @Override public String evaluate(RuleContext ctx, Map<String, String> r) { return MaidStateReader.getOwnerHoldingItemId(ctx.maid()); }
}
