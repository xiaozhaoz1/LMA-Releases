...
/** 女仆正在用盾牌格挡。 */
@RuleCondition
public final class MaidIsBlockingCondition implements ICondition {
    @Override public String key() { return "maid_is_blocking"; }
    @Override public String displayName() { return "女仆格挡"; }
    @Override public ConditionCategory category() { return ConditionCategory.MAID; }
    @Override public ConditionValueType valueType() { return ConditionValueType.BOOL; }
    @Override
    public String evaluate(RuleContext ctx, Map<String, String> rawParams) {
        return String.valueOf(MaidStateReader.isBlocking(ctx.maid()));
    }
}
