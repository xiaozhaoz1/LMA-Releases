...
@RuleCondition
public final class TargetHealthCondition implements ICondition {
    @Override public String key() { return "target_health"; }
    @Override public String displayName() { return "目标生命"; }
    ...
    @Override public String evaluate(RuleContext ctx, Map<String, String> r) { return ctx.target()!=null?String.format("%.1f",TargetStateReader.getHealth(ctx.target())):"0"; }
}
