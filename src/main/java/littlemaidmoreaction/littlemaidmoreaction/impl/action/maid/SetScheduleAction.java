...
@RuleAction
public final class SetScheduleAction implements IAction {
    private static final List<TypedParam<?>> PARAMS = List.of(new TypedParam.SelectParam("schedule", "日程", "ALL", List.of("ALL", "DAY", "NIGHT")));
    @Override public String id() { return "set_schedule"; }
    @Override public String displayName() { return "切换日程"; }
    ...
    @Override public void execute(RuleContext ctx, Map<String, String> raw) {
        ...
        MaidStateWriter.setSchedule(ctx.maid(), p.getString("schedule"));
    }
}
