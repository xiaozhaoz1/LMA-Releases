...
@RuleAction
public final class SetMaidTaskAction implements IAction {
    private static final List<TypedParam<?>> PARAMS = List.of(new TypedParam.SelectParam("task", "任务", "attack", List.of("attack", "milk", "shear", "torch", "feed", "heal", "follow", "stand", "wander", "pickup")));
    @Override public String id() { return "set_maid_task"; }
    @Override public String displayName() { return "切换工作"; }
    ...
    @Override public void execute(RuleContext ctx, Map<String, String> raw) {
        ...
        MaidStateWriter.setTask(ctx.maid(), "touhou_little_maid:" + p.getString("task"));
    }
}
