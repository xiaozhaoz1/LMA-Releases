...
import littlemaidmoreaction.littlemaidmoreaction.compat.vanilla.api.input.InventoryReaderProvider;
import littlemaidmoreaction.littlemaidmoreaction.compat.vanilla.api.input.InventorySpaceProvider;
import littlemaidmoreaction.littlemaidmoreaction.compat.vanilla.input.container.WirelessChestReader;
import littlemaidmoreaction.littlemaidmoreaction.compat.vanilla.input.container.WirelessChestSpace;
import littlemaidmoreaction.littlemaidmoreaction.compat.vanilla.input.maid.MaidInventoryReader;
import littlemaidmoreaction.littlemaidmoreaction.compat.vanilla.input.maid.MaidInventorySpace;
