package littlemaidmoreaction.littlemaidmoreaction.vanilla.input.item;
 ...
 * {@link littlemaidmoreaction.littlemaidmoreaction.task.service.ToolJudge}，
 * 本类只提供原子事实。耐久/附魔基础读取见
 * {@link littlemaidmoreaction.littlemaidmoreaction.vanilla.output.item.ItemOutput}。
 */
