...
public final class PassiveSenseRegistration {
    ...
    private static void registerIfExists(String taskType, String className) {
        try {
            Class<?> clazz = Class.forName("littlemaidmoreaction.littlemaidmoreaction." + className);
            var pipeline = (littlemaidmoreaction.littlemaidmoreaction.task.api.TaskPipeline) clazz
